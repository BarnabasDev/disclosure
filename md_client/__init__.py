...
doc = """
Client session (mandatory disclosure): Client observes the advisor's suggestion 
and full bonus information, then decides whether to follow or abstain.
"""


class C(BaseConstants):
    NAME_IN_URL = 'md_client'
